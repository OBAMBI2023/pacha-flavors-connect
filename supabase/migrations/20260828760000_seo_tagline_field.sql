-- Adds the tenant "slogan"/tagline field requested for the SEO Admin config
-- (used in the schema.org `slogan` property and as an optional title
-- enhancer) and exposes it via get_public_menu, same pattern as every other
-- SEO field added in the two preceding migrations.
