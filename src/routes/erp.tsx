...
const TITLE = "ERP Entreprise — Bientôt disponible | SAOVIA";

/**
 * Placeholder only -- ERP Entreprise has no implemented functionality
...
export const Route = createFileRoute("/erp")({
  ...
  component: ErpComingSoonPage,
});

function ErpComingSoonPage() {
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      <main className="flex flex-1 flex-col items-center justify-center px-4 py-24 text-center">
        ...
        <h1 className="mt-4 font-display text-3xl font-semibold sm:text-4xl">ERP Entreprise</h1>
