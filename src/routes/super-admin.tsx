      ...
      <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[240px_minmax(0,1fr)]">
        <aside className="rounded-3xl border border-white/10 bg-slate-950/95 p-5 text-slate-100 shadow-2xl shadow-black/25">
          ...
          <nav className="mt-8 space-y-2 text-sm">
            <a className="block rounded-2xl bg-white/10 px-4 py-3 text-white" href="#overview">Vue d&apos;ensemble</a>
            <a className="block rounded-2xl px-4 py-3 text-slate-300 hover:bg-white/5 hover:text-white" href="#restaurants">Restaurants</a>
            <a className="block rounded-2xl px-4 py-3 text-slate-300 hover:bg-white/5 hover:text-white" href="#subscriptions">Abonnements</a>
            <a className="block rounded-2xl px-4 py-3 text-slate-300 hover:bg-white/5 hover:text-white" href="#settings">Parametres</a>
          </nav>
