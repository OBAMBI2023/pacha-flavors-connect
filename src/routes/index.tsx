...
// "/" is the official SAOVIA Food B2B homepage (see Phase 3U): this is the
// same landing page previously served at /food (src/routes/food.tsx, which
// now 301s here -- see that file), not a copy. The marketplace lives at
// /restaurants, tenant storefronts at /r/$slug.
