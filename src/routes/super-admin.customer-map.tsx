    ...
    <div className="space-y-6">
      ...
      {mode === "clients" ? (
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <SuperAdminKpiCard icon={MapPin} label="Clients localisés" value={result.kpis.geolocated.toLocaleString("fr-FR")} />
          ...
          <SuperAdminKpiCard icon={Wallet} label="CA clients" value={formatMoney(result.kpis.total_revenue, revenueCurrency)} />
        </div>
      ) : (
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <SuperAdminKpiCard icon={Building2} label="Tenants localisés" value={tenantMap.kpis.located.toLocaleString("fr-FR")} />
          <SuperAdminKpiCard icon={Compass} label="Zones couvertes" value={tenantMap.kpis.zones_covered.toLocaleString("fr-FR")} />
          <SuperAdminKpiCard icon={ShoppingBag} label="Commandes" value={tenantMap.kpis.total_orders.toLocaleString("fr-FR")} />
          <SuperAdminKpiCard icon={Wallet} label="CA" value={formatMoney(tenantMap.kpis.total_revenue, revenueCurrency)} />
        </div>
      )}
