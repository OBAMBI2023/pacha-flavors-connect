...
interface SheetContentProps
  ...
  /** Optional className override for the overlay behind this sheet -- defaults to SheetOverlay's own styling. */
  overlayClassName?: string;
  /** Accessible name for the built-in close button -- defaults to "Close" so every existing sheet is unaffected. */
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, overlayClassName, closeButtonLabel = "Close", children, ...props }, ref) => (
  <SheetPortal>
