...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      customer_order_lookup_throttle: {
        Row: {
          call_count: number
        ...
        Relationships: [
          {
            foreignKeyName: "customer_order_lookup_throttle_restaurant_id_fkey"
            columns: ["restaurant_id"]
            isOneToOne: false
            referencedRelation: "restaurants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      notify_driver_nearby: { Args: { p_order_id: string }; Returns: string }
      quote_delivery: {
        Args: {
          p_destination_lat: number
          p_destination_lng: number
      ...
      send_restaurant_message_notification: {
      ...
      update_notification_preferences: {
        Args: {
          p_delivery_updates?: boolean
          p_enabled?: boolean
          p_order_updates?: boolean
          p_promotions?: boolean
          p_restaurant_messages?: boolean
          p_system_notifications?: boolean
        }
        Returns: {
          delivery_updates: boolean
          enabled: boolean
